...
public class MediaRecordController {
    ...
    public AtomicBoolean mAudioThreadCancel = new AtomicBoolean(true);

    public static LinkedBlockingQueue<AudioData> mAudioOutBufferQueue =new LinkedBlockingQueue<AudioData>(QUEUE_MAX_COUNT);
...
//            });
    ...
    public void setupController(OnRecordListener listener) {
        this.setupController(listener, mBitRate, mDensityDpi, mWidth, mHeight);
    }

    public void setupController(OnRecordListener listener, int bitrate,
